 ...
 * @property {boolean} colors - Whether to use colors
 * @property {boolean} icons - Whether to use icons
 * @property {boolean} debug - Whether to show debug messages
 */
...
/**
 * Formats a log message with colors, icons, and timestamp based on config.
 * @param {string} level - The log level
 * @param {string} message - The message to log
 * @param {LoggerConfig} config - The logger configuration
 * @returns {string} The formatted message
 */
export function formatMessage(level, message, config) {
